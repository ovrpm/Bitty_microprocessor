// =============================================================================
// Bitty Core - 16-bit RISC-style Educational Processor
// Integrates ALU, register file (8 registers), mux, and control unit
// =============================================================================
// I/O Ports:
//   clk, reset        - Clock and reset signals
//   instruction[15:0]- Instruction input
//   run               - Processor enable
//   done              - Instruction complete flag
//   reg0_out-reg7_out- Debug: register outputs
//   regc_extra_out    - Debug: accumulator output
//   regs_extra_out    - Debug: source register output
//   mux_sent          - Debug: current mux select
//   instruction_out   - Debug: current instruction
// =============================================================================
